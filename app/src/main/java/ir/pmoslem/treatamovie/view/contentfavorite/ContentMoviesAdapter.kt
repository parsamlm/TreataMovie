...
private lateinit var contentItemListener: ItemChangeListener
...
class ContentMoviesAdapter constructor(itemChangeListener: ItemChangeListener) :
    ...
    init {
        contentItemListener = itemChangeListener
    }
    ...
    class MovieViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(movie: Movie) {
            ...
            moreDetailBtn.setOnClickListener {
                contentItemListener.onDetailsButtonClicked(movie)
            }
        }
...
interface ItemChangeListener {
    ...
    fun onDetailsButtonClicked(movie: Movie)
}
